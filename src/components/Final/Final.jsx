...
const handleTrackProgressChange = (e) => {
    setTrackProgress(e.target.checked);
};

const handleKnowledge = async (known, questionId) =>{
    try{
      await axios.post(`${baseURL}/addKnowledge`,{
        known: known,
        questionId: questionId
      },{
        headers: {Authorization : `Bearer ${token}`}
      ...
      <div className="all-card">
        ...
        {trackProgress?
          <div className="spread-apart">
            <button className='buttonFinal' onClick={() => handleKnowledge(false, questionId)}>Unknown</button>
            <button className='buttonFinal' onClick={shuffle}>Shuffle</button>
            <button className='buttonFinal' onClick={() => handleKnowledge(true, questionId)}>Known</button>
          </div>
          :
          <div className="spread-apart">
        ...
        <div className="toggleWrapper">
          <label className="quiz-toggle">
            <input type="checkbox" checked = {trackProgress} onChange = {handleTrackProgressChange}/>
            <span className="slider"></span>
          </label>
          <span className="textToggle">Do you want to track progress?</span>
        </div>
      </div>
    </div>
    </>
